...
Route::middleware(['auth',])->group(function () {
    ...
    Route::get('/home/{lotteryId}/lotteryinfo', 'LotteryController@showLotteryInfo')->name('lottery.info.show');
    ...
    Route::resource('home/lots','LotController');
    Route::get('/home/lotswithoutadvertise/{lotId}', 'LotController@showWithoutAdvertise')->name('lots.withoutadvertise.show');
    ...
    Route::get('home/lottery/{id}/stocks','LotteryController@lotteryStocksShowPage')->name('stocks.lottery.index');


    Route::resource('home/installments','InstallmentController');
    Route::get('home/{lotId}/manageofinstallments','InstallmentController@manageInstallments')->name('installments.manage');
